...
imgfile = random.choice(file_names)
print('choose image file is', imgfile)
#os.system('eog %s/%s &'%(IMAGE_DIR, imgfile))
image = skimage.io.imread(os.path.join(IMAGE_DIR, imgfile))
